...
// based on https://github.com/shift-reality/php-crypto/blob/newlib/src/Builtin/Skein256Impl.php

namespace Cast\Crypto\Skein;

use Cast\Crypto\Skein\Util\UnsignedInt64 as o_u64;
...
class Skein256
{
    ...
    {
        $inputData = InputDataSupplier::forBinaryString($input)->getInputData();
        $digest1 = (new self())->digest1($inputData);
        $binaryString = implode('', array_map('chr', $digest1));
